...
```{r functions, echo = TRUE, message=FALSE, warning=FALSE,  results='hide'}
#####################################################################
...
```{r single_site_curves, echo = TRUE, warning=FALSE,  results='hide'}
...
```{r curve_normalization, echo = TRUE, warning=FALSE,  results='hide'}
...
```{r cluster_final_fit, echo = TRUE, warning=FALSE,  results='hide'}
...
```{r plm_curves, echo = TRUE, warning=FALSE,  results='hide'}
options(scipen=9999)
rm(list = ls()[sapply(ls(), function(x) length(dim(get(x))) > 1)])
